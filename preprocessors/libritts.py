...
class Preprocessor:
    ...
    def build_from_path(self, data_dir, out_dir):
        ...
        f_json = {
            ...
            "n_frames": n_frames,
            "f0_state": [f0_max, f0_min, f0_mean, f0_std],
            "energy_state": [energy_max, energy_min, energy_mean, energy_std]
        }
        #print("f_json: {}".format(f_json))
        with open(os.path.join(out_dir, 'stats.json'), 'w') as f:
            json.dump(eval(str(f_json)), f)
        return datas
    ...
    def process_utterance(self, in_dir, out_dir, basename, dataset='libritts'):
        ...
        if not os.path.exists(wav_path) or not os.path.exists(tg_path):
            return None
        #print("wav_path, tg_path: {},{}".format(wav_path, tg_path))
        # Get alignments
        ...
        #print("wav_path, f0: {},{}".format(wav_path, f0))
